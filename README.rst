...
Provide funding to **renew python-pillow.org** for maximum period of time of 8 years. [0]_ By doing so, we can ensure security issues can be reported discretely to `security@python-pillow.org <mailto:security@python-pillow.org>`_ for the foreseeable future.
